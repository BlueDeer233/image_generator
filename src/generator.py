...
upper_font_path = path.join(path.dirname(__file__), '../fonts/NotoSansCJKSC-Black.ttf')
downer_font_path = path.join(path.dirname(__file__), '../fonts/NotoSerifCJKSC-Black.ttf')
